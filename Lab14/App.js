...
function BMICalcDemo() {
    ...
    const calculateBMI = ()=> {
        ...
        if( bmi < 16)
        window.alert("Hi.."+name+"...You are completely UnderWeight (Severe Thinner)"); else
        if( bmi >=16 && bmi < 17)
        window.alert("Hi.."+name+"...You are Moderately UnderWeight (Moderate Thinner)"); else
        if( bmi >=17 && bmi < 18.5)
        window.alert("Hi.."+name+"...You are little UnderWeight (Mild Thinness)"); else
